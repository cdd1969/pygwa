...
#
# A smooth way to paste data you are working with in python into a spreadsheet.
# Put into the system clipboard, select a cell and do ctrl-v (at least with ms office and libre-office).
#
