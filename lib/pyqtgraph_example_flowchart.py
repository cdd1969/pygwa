...
from flowchart.customnode_readtextdata import readTextDataNode
...
library.addNodeType(readTextDataNode, [('My',)])
library.addNodeType(viewPandasDfNode, [('My',)])
library.addNodeType(selectDfColumnNode, [('My',)])
...
#fNodez = fc.createNode('readTextData', pos=(-150, -150))
#fNodez = fc.createNode('viewPandasDf', pos=(-150, -300))
