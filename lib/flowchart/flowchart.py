...
Original code: pyqtgraph, branch <devel>, commit <0976991efda1825d8f92b2462ded613bcadef188>
"""
...
if USE_PYSIDE:
    ...
    from pyqtgraph.flowchart import FlowchartTemplate_pyqt5 as FlowchartTemplate
    from pyqtgraph.flowchart import FlowchartCtrlTemplate_pyqt5 as FlowchartCtrlTemplate
else:
